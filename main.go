...
const (
	...
	InvalidMessage = "Namespace modification forbidden"
	port           = ":8443"
)
...
func NSValidate(w http.ResponseWriter, r *http.Request) {
	...
	if strings.HasPrefix(ns.Metadata.Name, "openshift") {
...
func main() {
	...
	http.HandleFunc("/namespace-validation", NSValidate)
