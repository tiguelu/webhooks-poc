...
RUN mkdir -p /go/src/github.com/tiguelu/webhooks-poc
WORKDIR /go/src/github.com/tiguelu/webhooks-poc
...
COPY --from=build /go/src/github.com/tiguelu/webhooks-poc/main .
